...
app.use(
  session({
    store: MongoStore.create({ mongoUrl:"mongodb+srv://fcurrao1:fcurrao1@cluster0.pzrcxla.mongodb.net/ecommerce?retryWrites=true&w=majority", ttl: 7200 }),
    secret: 'secreto',
    resave: true,
...
const swaggerDefinition = {
  openapi: '3.0.0',
  info: {
    title: 'API de e-commers Bonsais y frutas',
    version: '1.0.0',
    description: 'Entregable',
  },
  servers: [
    {
      url: process.env.SWAGGER_SERVER_URL_LOCAL || 'https://coder-backend-borlando3q.onrender.com',
    },
  ],
};
