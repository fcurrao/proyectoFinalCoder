...
async function sendPurchaseCompleted(userEmail, productsPurchased) {
  try {
    ...
    const mailOptions = {
      ...
      html: ` <img width="300" src=src="https://s1.eestatic.com/2018/11/21/ciencia/nutricion/nutricion-frutas-higiene_354976032_106782952_1706x960.jpg" href="/api/products" alt="Logo">
              <p>Queremos confirmarte la compra de los siguientes productos:</p> ${productList}
              <p>Gracias por tu compra! Bonsais y frutas</p>`,
    };
