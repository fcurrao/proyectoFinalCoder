...
async recoverPassword(req, res) {
  try {
    ...
    const resetPasswordLink = `https://localhost:8080/auth/reset-password/${jwtToken}`;
    // const resetPasswordLink = `https://coder-backend-borlando3q.onrender.com/auth/reset-password/${jwtToken}`;
